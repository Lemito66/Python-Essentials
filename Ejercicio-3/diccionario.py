...
diccionarioDos = {'tplA': (4, -12, 56, -34, 98, 102),
                  'tplB': (9, 0, 1, 10, -3, 14), 'tlpC': (87, 12, 56, 987, -61)}
diccionarioTres = {'val1': -12.5, 'val2': 12.5, 'val3': 83,
                   'val4': 2.1, 'val5': 23, 'val6': 100, 'val7': 13.4, 'val8': 92}
diccionarioCuatro = {'lst1': [4, 6, -12, 56, -9, 5.7, 33, 100],
                     'lst2': [9, 0, 81, -2, -56, ], 'lst3': [12, 31, 87, 1, 0, 4, -11]}
...
# if valor ==1:
#     valorMaximo = max(diccionario, key=diccionario.get)
#     print(valorMaximo)
